...
*/
var sul = ['Santa Catarina', 'Paraná', 'Espirito Santo'];
...
brasil.unshift('Piaui', 'Maranhão', 'Rio Grande do Norte');
console.log(brasil);
...
*/
var nordeste = ['Ceará', 'Paraíba', 'Bahia', 'Sergipe', 'Pernambuco']
...
if (every == true)
	console.log('Sim todos estados tem mais de 7 letras')
else
