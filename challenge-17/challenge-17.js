...
(function() {
	...
	*/
	...
	console.log(text.replace(/Manuel Marques de Sousa/, 'Bruno Soares'));
	...
	*/
	console.log( '\nReplace de datas:' );
	console.log(text.replace(regexDate, function replaceDate( regex, day, month, year ) {
		return day + '/' + getMonthNumber(month) + '/' + year;
	}));

	var textoComTab = 'Some texto goes here,		 	just for testing\n';
	console.log(textoComTab);
	var textoComSpace = textoComTab.replace(/\t/, '    ');
	console.log(textoComSpace);
