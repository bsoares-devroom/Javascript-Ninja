...
*/
console.log( '\nOperation:' );
var operation = justMod2Or3.reduce(function(acunulado, atual) {
	return (acunulado + 1) * atual;
}, 0);
...
*/
console.log( '\nOperation 2:' );
var operation2 = justMod2Or3.reduceRight(function(acunulado, atual) {
	return (acunulado + 1) * atual;
}, 0);
...
if (numberObjects.indexOf(obj) > -1) {
	console.log( '\nSIM, Existe um { number: 2 } em numberObjects' );
}
else {
	console.log( '\nNAO, Existe um { number: 2 } em numberObjects' );
}
/*
